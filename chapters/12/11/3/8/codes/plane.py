...
tri_coords = np.block([A])  # Stack A, B, C vertically
...
#if using termux
plt.savefig('chapters/12/11/3/8/figs/fig.pdf')
subprocess.run(shlex.split("termux-open chapters/12/11/3/8/figs/fig.pdf"))
#else
#plt.show()
