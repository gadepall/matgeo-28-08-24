\begin{enumerate}[label=\thesubsection.\arabic*.,ref=\thesubsection.\theenumi]
    ...
    \resizebox{0.75\columnwidth}{!}{
	    \input{figs/ckts/ckt1/main.tex} % Adjust width or use height
    }
    \caption{} 
    \label{fig:ckt1} 
\end{figure}
    ...
    \centering
    \resizebox{0.75\columnwidth}{!}{
	    \input{figs/ckts/ckt2/main.tex} % Adjust width or use height
    }
...
\end{figure}
    ...
    \resizebox{0.5\columnwidth}{!}{
	    \input{figs/ckts/ckt3/main.tex} % Adjust width or use height
    }
    \caption{} 
    \label{fig:ckt3} 
\end{figure}
...
\figref{fig:ckt4}.
    ...
    \resizebox{0.4\columnwidth}{!}{
	    \input{figs/ckts/ckt4/main.tex} % Adjust width or use height
    }
    \caption{} 
    \label{fig:ckt4} 
\end{figure}
