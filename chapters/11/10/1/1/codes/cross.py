...
#if using termux
plt.savefig('chapters/11/10/1/1/figs/fig.pdf')
subprocess.run(shlex.split("termux-open chapters/11/10/1/1/figs/fig.pdf"))
#else
#plt.show()
