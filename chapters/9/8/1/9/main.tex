...
\thiswatermark{\centering \put(0,-110.0){\includegraphics[width=0.75\columnwidth]{logo.png}} }
\title{\mytitle}
...
See Fig. 
 	...
 	\begin{figure}
		\centering
 \includegraphics[width=0.75\columnwidth]{chapters/9/8/1/9/figs/output.pdf}
		\caption{}
		\label{fig:9/8/1/9}
  	\end{figure}
