...
tri_coords = np.block([O,P1,P2])
plt.scatter(tri_coords[0,:], tri_coords[1,:], c=colors)
vert_labels = ['$\mathbf{O}$','$\mathbf{P}_1$','$\mathbf{P}_2$']
...
#if using termux
plt.savefig('chapters//11/11/4/14/figs/fig.pdf')
subprocess.run(shlex.split("termux-open chapters//11/11/4/14/figs/fig.pdf"))
#else
#plt.show()
