...
vert_labels = ['$\mathbf{O}$','$\mathbf{P}$','$\mathbf{q}_1$','$\mathbf{q}_2$']
...
#if using termux
plt.savefig('chapters/12/6/5/27/figs/fig.pdf')
subprocess.run(shlex.split("termux-open chapters/12/6/5/27/figs/fig.pdf"))
#else
#plt.show()
